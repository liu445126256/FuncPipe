...
from pipetests.models.amoebanet.genotype import (NORMAL_CONCAT, NORMAL_OPERATIONS, REDUCTION_CONCAT,
                                REDUCTION_OPERATIONS)
from pipetests.models.amoebanet.operations import FactorizedReduce
